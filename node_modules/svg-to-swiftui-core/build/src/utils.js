 ...
 */
export function convertToPixels(num) {
 ...
 * @param svgJsonTree
 */
export function extractSVGProperties(svg) {
    var _a, _b, _c;
    // Extract needed properties.
    var viewBox = (_a = svg.properties) === null || _a === void 0 ? void 0 : _a.viewBox;
    var width = (_b = svg.properties) === null || _b === void 0 ? void 0 : _b.width;
    var height = (_c = svg.properties) === null || _c === void 0 ? void 0 : _c.height;
    ...
    var viewBoxElements = String(viewBox)
        .split(' ')
        .map(function (n) { return parseFloat(n); });
    var vbx = viewBoxElements[0], vby = viewBoxElements[1], vbWidth = viewBoxElements[2], vbHeight = viewBoxElements[3];
    var viewBoxValid = viewBoxElements.every(function (value) { return !isNaN(value); });
 ...
 */
export function getSVGElement(rootNode) {
    ...
    while (frontier.length > 0) {
        ...
        if (currentNode && typeof currentNode !== 'string') {
            if (currentNode.type === 'root') {
                ...
                frontier.push.apply(frontier, currentNode.children);
                continue;
            }
 ...
 * height, etc.)
 */
export function clampNormalisedSizeProduct(value, suffix) {
 ...
 */
export function normaliseRectValues(rect, viewBox) {
...
export function stringifyRectValues(rect, precision) {
